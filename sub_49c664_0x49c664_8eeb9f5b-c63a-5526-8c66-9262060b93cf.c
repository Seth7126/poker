...
char** __convention("regparm")sub_49c664(int32_t* arg1, int32_t arg2, uint32_t* arg3, uint32_t* arg4, char** arg5)
{
    // 第一条实际指令: int32_t ebp
    int32_t ebp
    int32_t var_4 = ebp
    ...
    int32_t var_8 = 0x10
    int16_t var_18
    (*data_52ff94)(arg2, &var_18, &var_8, ExceptionList, var_30, var_2c)
    sub_49ada4()
    *arg3 = zx.d(var_18)
    (*(*arg1 + 0x7c))(var_8)
