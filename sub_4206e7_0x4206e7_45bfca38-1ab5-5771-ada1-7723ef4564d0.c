...
// 函数名称: sub_4206e7
// 虚拟地址: 0x4206e7
// WARP GUID: 45bfca38-1ab5-5771-ada1-7723ef4564d0
...
int32_t __convention("regparm")sub_4206e7(char* arg1, int16_t arg2, int32_t arg3, int32_t* arg4 @ ebp, uint16_t* arg5 @ esi, int32_t* arg6 @ edi)
{
    // 第一条实际指令: *arg6 -= 1
    *arg6 -= 1
    *arg1 += arg1.b
        ...
        if (data_5316f2 != 0)
            ...
            if (arg4[2] == 0x12340042 && esi_3 != 0 && *esi_3 u>= 0x28)
                ...
                if (SystemParametersInfoA(SPI_GETWORKAREA, 0, &arg4[-4], 0) != 0)
                    ...
                    if (*esi_3 u>= 0x4c)
                        lstrcpyA(&esi_3[0xa], sub_4207bf+0x15)
                        esp = &var_1d
            ...
            int32_t edi_1
            eax, arg4, edi_1 = sub_4202fc(arg1.b, data_5316d8, sub_4207bf+5)
            data_5316d8 = eax
            esp = &var_1d
            entry_result = data_5316d8(edi_1, esi_3)
