...
// [交叉引用字符串]: 无
// [外部 API 调用]: 无
// [内部子函数调用]: sub_4bedc4, sub_403010
// [被调用的父级函数]: sub_4bedc4, sub_4bf070
// ============================================================

void __fastcallsub_4bedc4(int32_t arg1, int32_t arg2, int32_t arg3 @ eax, long double arg4 @ st0, long double arg5 @ st1, char arg6, char arg7, char arg8, int32_t arg9, char arg10, int32_t arg11)
{
    // 第一条实际指令: int32_t ebx
    int32_t ebx
    int32_t var_20 = ebx
    ...
    if (i == 1)
        ...
        if (i != 2 || arg10 == 0)
            ...
            if (arg6 != 0)
                ...
                sub_4bedc4(0, 0, 0, 0, 0, 0, 0, arg11)
