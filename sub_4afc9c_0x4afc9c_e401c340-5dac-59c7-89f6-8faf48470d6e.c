...
// 函数名称: sub_4afc9c
// 虚拟地址: 0x4afc9c
// WARP GUID: e401c340-5dac-59c7-89f6-8faf48470d6e
...
int32_t __convention("regparm")sub_4afc9c(void* arg1, void* arg2)
{
    // 第一条实际指令: int32_t ebp
    int32_t ebp
    int32_t var_4 = ebp
    ...
    void* ebp_1 = sub_49e7fc(*(*(arg1 + 0x104) + 0x14), eax[5], 0x4aff8c, eax, edi_1, &var_8)
    sub_403e4c(*(arg1 + 0x104) + 0x14, *(ebp_1 - 4))
    ...
    if (sub_404078(eax[4]) s<= 0)
        if (sub_408ad8(eax[2], "http") == 0)
            char eax_36
            int32_t edx_13
            eax_36, edx_13 = sub_408ad8(eax[2], "https")
            ...
            if (eax_36 == 0)
                ...
                sub_408e1c(0x1bb, ebp_1 - 0xc)
                sub_403e4c(*(arg1 + 0x104) + 0x10, *(ebp_1 - 0xc))
        else
            sub_408e1c(0x50, ebp_1 - 8)
            sub_403e4c(*(arg1 + 0x104) + 0x10, *(ebp_1 - 8))
    else
    ...
    char eax_50 = *(edi_1 + 0x90)
    bool cond:0 = eax_50 == 2
    char temp2_1
    ...
    if (eax_50 != 2 && temp2_1 != 3)
        cond:0 = false
        sub_4a2dfc(edi_1, 0xffffffff)
    else
        sub_4a2dfc(edi_1, sub_4128c0(*(edi_1 + 0x94)))
    
    sub_408e1c(0x50, ebp_1 - 0x10)
    sub_404188(*(*(arg1 + 0x104) + 0x10), *(ebp_1 - 0x10))
