...
// 函数名称: sub_46a50c
// 虚拟地址: 0x46a50c
// WARP GUID: fc4fa4d1-486b-5568-b3d8-597ccd2564d0
...
int32_t __fastcallsub_46a50c(int32_t arg1, int32_t arg2, void* arg3 @ eax, int32_t arg4, int32_t arg5, int32_t arg6, int32_t arg7)
{
    ...
    (*data_52ffd4)(7)
    (*data_5307f8)(0x3f7ae148, 0x3cf5c28f)
    (*data_530368)(0, 0, 0)
    (*data_5307f8)(0x3f7ae148, 0x3e570a3d)
    (*data_530368)(0, fconvert.s(fneg(fconvert.t(var_14))), 0)
    (*data_5307f8)(0x3f570a3d, 0x3e570a3d)
    (*data_530368)(var_10, fconvert.s(fneg(fconvert.t(var_14))), 0)
    (*data_5307f8)(0x3f570a3d, 0x3cf5c28f)
