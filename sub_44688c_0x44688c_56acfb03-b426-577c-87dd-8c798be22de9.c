...
// [交叉引用字符串]: 无
// [外部 API 调用]: 无
// [内部子函数调用]: sub_403248, sub_42e7fc, sub_42e838, sub_44685c, sub_44688c
// [被调用的父级函数]: sub_44688c, sub_446908
// ============================================================

int32_t __convention("regparm")sub_44688c(void* arg1, int32_t arg2)
{
    // 第一条实际指令: int32_t ecx
    int32_t ecx
    int32_t var_8 = ecx
