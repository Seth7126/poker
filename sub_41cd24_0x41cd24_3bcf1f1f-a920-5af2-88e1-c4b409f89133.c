...
// [交叉引用字符串]: 无
// [外部 API 调用]: 无
// [内部子函数调用]: sub_410948, sub_41ceb4, sub_419a38, sub_4108e4, sub_410524, sub_4199dc
// [被调用的父级函数]: sub_42f010, sub_41fdd8
// ============================================================
...
int32_tsub_41cd24()
{
    ...
    int32_t var_4 = ebp
    int32_t* ebp_1 = &var_4
    void* eax_1 = sub_4108e4(data_52e624)
