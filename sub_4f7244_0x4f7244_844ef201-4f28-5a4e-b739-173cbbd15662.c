...
void*sub_4f7244(void* arg1)
{
    ...
    if (not(test_bit(eax_2:1.b, 0)))
        ...
        if (test_bit(eax_15:1.b, 0))
            *(*(arg1 + 8) - 0x30) = fconvert.s(sub_402b2c(
                float.t(*(arg1 - 8)) / float.t(*(*(arg1 + 8) - 0x50)) * fconvert.t(1f) * data_4f73a4
                + data_4f73b0) + fconvert.t(-0.5f))
    ...
    *(*(arg1 + 8) - 0x30) = fconvert.s(data_4f73c0 * fconvert.t(*(*(arg1 + 8) - 0x30)))
    void* result = *(arg1 + 8)
    *(result - 0x34) = fconvert.s(data_4f73c0 * fconvert.t(*(*(arg1 + 8) - 0x34)))
    return result
}
