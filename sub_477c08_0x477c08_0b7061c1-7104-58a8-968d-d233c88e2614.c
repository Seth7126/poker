...
// 函数名称: sub_477c08
// 虚拟地址: 0x477c08
// WARP GUID: 0b7061c1-7104-58a8-968d-d233c88e2614
...
int32_t __convention("regparm")sub_477c08(void* arg1, int32_t arg2, int32_t arg3, int32_t arg4 @ esi, int32_t arg5 @ edi, long double arg6 @ st0)
{
    // 第一条实际指令: int32_t ebp
    int32_t ebp
    int32_t var_4 = ebp
    ...
    *(esp_1 - 0x18) = fsbase->NtTib.ExceptionList
    ...
    int32_t eax_2 = *(arg1 + 0xab0) + i_2 * 0x81c0
    
    if (i_3 - 1 u> 0x75)
        sub_403008()
        noreturn
    
    int32_t edx_1 = i_3 * 0x23
    ...
    if (ecx.b == 0xc)
        ...
        *(esp_8 - 8) = &var_10
        ...
        if (eax_4.b == 0x24)
            *(ebx + 0x72) = 0
            *(ebx + 0x74) = 0
        else if (eax_4.b == 0x23)
            int32_t eax_7 = sub_404078(*(ebp_2 - 0xc)) + 0x8000
            
            if (eax_7 u> 0xffff)
                sub_403008()
                noreturn
            
            *(ebx + 0x72) = eax_7.w - 0x8000
        else if (eax_4.b == 0x2e)
            if (sub_404078(*(ebp_2 - 0xc)) s> sx.d(*(ebx + 0x72)))
                ...
                sub_4042c0(ebp_2 - 0xc, edx_4 + 1, 1)
                *(esp_11 - 4) = *(ebp_2 - 0xc)
                ebx = sub_47ab08(arg1, *(ebp_2 - 4), i_3, arg6)
                esp_11 += 0x20
        else if (eax_4.b == 8)
            eax_4 = *(ebx + 0x72)
            
            if (eax_4 s> 0)
                sub_4042c0(ebp_2 - 0xc, sx.d(eax_4), 1)
                *(esp_11 - 4) = *(ebp_2 - 0xc)
                ebx = sub_47ab08(arg1, *(ebp_2 - 4), i_3, arg6)
                esp_11 += 0x20
                ...
                *(ebp_2 - 0xd) = 0
                ...
                if (eax_4 == 0 || eax_4 == 3)
                    ...
                    if (eax_4 != 3)
                        ...
                        if (not(c_2) && (eax_4.b u< 0x30 || eax_4.b u> 0x7a))
                            eax_4 = 0
                        else
                            eax_4.b = 1
                        ...
                        *(ebp_2 - 0xd) = eax_4.b
                        ...
                        if (not(c_1) && (eax_4.b u< 0x30 || eax_4.b u> 0x7a))
                            eax_4 = 0
                        else
                            eax_4.b = 1
                ...
                if (*(ebx + 0xee) - 1 u< 2)
                    ...
                    if (eax_20.b u< 0x30 || eax_20.b u> 0x39)
                        eax_20 = 0
                    else
                        eax_20.b = 1
                ...
                if (sub_404078(*(ebp_2 - 0xc)) s>= sx.d(*(ebx + 0x76)))
                    *(ebp_2 - 0xd) = 0
                ...
                if (*(ebp_2 - 0xd) != 0)
                    ...
                    *(esp_11 - 8) = ebp_2 - 8
                    *(ebp_2 - 4)
                    ebp_2 = sub_47a7ec(i_3)
                    *(esp_11 - 4) = ebp_2 - 0xc
                    sub_404280(sx.d(*(ebx + 0x72)), 1, *(ebp_2 - 8))
                    int32_t edx_17
                    edx_17.b = *(ebp_2 + 0xc)
                    sub_403fa0()
                    sub_404080(ebp_2 - 0xc, *(ebp_2 - 0x1c))
                    *(esp_11 - 4) = ebp_2 - 0x20
                    int32_t eax_31 = sub_404078(*(ebp_2 - 8))
                    int32_t eax_32 = sx.d(*(ebx + 0x72))
                    int32_t ecx_7 = eax_31 - eax_32
                    
                    if (add_overflow(eax_31, neg.d(eax_32)))
                        sub_403010()
                        noreturn
                    ...
                    sub_404280(ecx_7 + 2, edx_19 + 1, *(ebp_2 - 8))
                    sub_404080(ebp_2 - 0xc, *(ebp_2 - 0x20))
                    *(esp_11 - 4) = *(ebp_2 - 0xc)
                    ebx = sub_47ab08(arg1, *(ebp_2 - 4), i_3, arg6)
                    esp_11 += 0x20
                    ...
                    *(ebx + 0x72) += 1
                    ...
                    if (add_overflow(temp26_1, 1))
                        sub_403010()
                        noreturn
            else if (sub_404078(*(ebp_2 - 0xc)) s> sx.d(*(ebx + 0x72)))
        ...
        int32_t eax_37 = sx.d(*(ebx + 0x72))
        int32_t edx_23 = sx.d(*(ebx + 0x74))
        
        if (add_overflow(eax_37, neg.d(edx_23)))
            sub_403010()
            noreturn
        
        if (eax_37 - edx_23 s< 0)
        ...
        *(esp_11 - 4) = ebp_2 - 0x24
        ...
        sub_404280(ecx_10 - edi_5, edi_5, *(ebp_2 - 0xc))
        esp_8 = esp_11
        ebp_1 = sub_46fd7c(arg1, *(ebp_2 - 0x24))
        ebp_1[-5] = fconvert.s(arg6)
        long double x87_r0_1 = float.t(*(ebx + 0x78)) + fconvert.t(ebp_1[-6])
        long double temp8_1 = fconvert.t(ebp_1[-5])
        x87_r0_1 - temp8_1
        int16_t top_1 = 1
            ...
            *(ebx + 0x74) = 0xffff
            ...
            do
                ...
                *(esp_8 - 4) = &ebp_1[-0xa]
                ...
                sub_404280(ecx_12 - edi_6, edi_6, ebp_1[-3])
                ebp_1 = sub_46fd7c(arg1, ebp_1[-0xa])
                ...
                long double temp17_1 = fconvert.t(ebp_1[-5])
                ...
                top_1 += 1
                eax_46 = (c0_2 ? 1 : 0) << 8 | (c2_2 ? 1 : 0) << 0xa | (c3_2 ? 1 : 0) << 0xe
                    | (top_1 & 7) << 0xb
            while (test_bit(eax_46:1.b, 6) || test_bit(eax_46:1.b, 0))
        
        int32_t eax_49 = sub_404078(ebp_1[-3]) + 0x8000
        
        if (eax_49 u> 0xffff)
            sub_403008()
            noreturn
        
        *(ebx + 0x7a) = eax_49.w - 0x8000
        
        while (true)
            *(esp_8 - 4) = &ebp_1[-0xb]
            sub_404280(sx.d(*(ebx + 0x7a)), sx.d(*(ebx + 0x74)), ebp_1[-3])
            ebp_1 = sub_46fd7c(arg1, ebp_1[-0xb])
            unimplemented  {fild st0, word [ebx+0x78]}
            unimplemented  {fadd dword [ebp-0x18]}
