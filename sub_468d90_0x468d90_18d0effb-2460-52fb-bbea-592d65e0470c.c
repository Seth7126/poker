...
// [被调用的父级函数]: sub_468e30, sub_468ec0, sub_468eb7
// ============================================================

char** __convention("regparm")sub_468d90(int32_t* arg1, void* arg2)
{
    // 第一条实际指令: int32_t ebp
    int32_t ebp
    int32_t var_4 = ebp
    ...
    while (eax_5.b == 0)
    fsbase->NtTib.ExceptionList = ExceptionList
    int32_t (__stdcall* var_1c_1)(int32_t arg1, int32_t arg2, int32_t arg3, int32_t arg4) = sub_468e28
    char** result = &var_c
    sub_403df8(result)
    return result
}
