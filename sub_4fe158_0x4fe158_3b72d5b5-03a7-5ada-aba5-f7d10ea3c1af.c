...
void* __stdcallsub_4fe158(int32_t arg1, int32_t arg2, int32_t arg3, void* arg4)
{
    ...
    if (*(result - 0x21) != 0)
        ...
        if (*(result - 0x22) == 0)
            ...
            *(data_53014c + *eax_1 * 0xc - 8) = arg3
            void* eax_3 = data_53014c
            *eax_3
            ...
            *(data_53014c + *eax_3 * 0xc - 4) = arg2
            int32_t* eax_5 = data_53014c
            *eax_5
            result = *eax_5 * 3
