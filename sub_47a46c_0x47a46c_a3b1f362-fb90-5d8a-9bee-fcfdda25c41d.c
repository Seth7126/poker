...
// 函数名称: sub_47a46c
// 虚拟地址: 0x47a46c
// WARP GUID: a3b1f362-fb90-5d8a-9bee-fcfdda25c41d
...
void* __convention("regparm")sub_47a46c(void* arg1, int32_t arg2, int32_t arg3, int32_t* arg4)
{
    // 第一条实际指令: int32_t ebp
    int32_t ebp
    int32_t var_4 = ebp
    ...
    char* eax_3 = *(arg1 + 0xab0) + arg2 * 0x81c0 + (esi_1 << 3) - 0xd6
    int32_t ecx
    ecx.b = *eax_3
    sub_402c90(eax_3, 0x47a5dc, ecx + 1)
    ...
    if (ecx == 0xffffffff)
        ...
        while (true)
            ...
            int32_t ecx_8 = sub_402c90(&ebp_1[-0x83], 0x47a5e4, ecx_6 + 1)
        ...
        sub_40401c(arg3, *(arg1 + 0xab0) + arg2 * 0x81c0 + (esi_1 << 3) - 0xd6)
    
    fsbase->NtTib.ExceptionList = ExceptionList
    int32_t (* var_220_1)(int32_t* arg1 @ ebp, int32_t arg2, int32_t arg3) = sub_47a5d0
