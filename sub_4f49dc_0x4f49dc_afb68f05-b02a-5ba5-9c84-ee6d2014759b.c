...
// 函数名称: sub_4f49dc
// 虚拟地址: 0x4f49dc
// WARP GUID: afb68f05-b02a-5ba5-9c84-ee6d2014759b
...
int32_tsub_4f49dc(void* arg1)
{
    ...
    *(arg1 - 0xc) = 0xfffffd7d
    ...
    if (neg.d(eax_25) == 0x80000000)
        sub_403010()
        noreturn
    
    (*data_5301d4)(
        fconvert.s(float.t(*(arg1 - 4)) / fconvert.t(100f) - data_4f4d38 + data_4f4d44
            + fconvert.t(0f)), 
        fconvert.s(float.t(neg.d(eax_25)) / fconvert.t(100f) + data_4f4d2c), 
    ...
    *(arg1 - 0x24) = 0
    *(arg1 - 0x28) = fconvert.s(data_4f4d54 * fconvert.t(*(arg1 - 0x20)))
    *(arg1 - 0x2c) = *(arg1 - 0x1c)
    *(arg1 - 0x30) = fconvert.s(fconvert.t(*(arg1 - 0x14)) - data_4f4d60 * fconvert.t(*(arg1 - 0x2c)))
    *(arg1 - 0x34) = fconvert.s(data_4f4d6c * fconvert.t(*(arg1 - 0x28)) + fconvert.t(*(arg1 - 0x18)))
    *(arg1 - 0x2c) = fconvert.s(data_4f4d78 * fconvert.t(*(arg1 - 0x2c)))
    *(arg1 - 0x28) = fconvert.s(data_4f4d84 * fconvert.t(*(arg1 - 0x28)))
    (*data_52ffd4)(6)
