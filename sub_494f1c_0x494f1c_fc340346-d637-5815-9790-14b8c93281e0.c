...
// 函数名称: sub_494f1c
// 虚拟地址: 0x494f1c
// WARP GUID: fc340346-d637-5815-9790-14b8c93281e0
// 源二进制: E:/torrent/BOARDGAMES/Texas Hold'em Poker 3D Deluxe Edition T/Poker3d.exe.bndb
// ------------------------------------------------------------
// [交叉引用字符串]: 无
// [外部 API 调用]: WSAStartup
...
int32_t*sub_494f1c()
{
    ...
    uint32_t eax = WSAStartup(0x101, 0x532138, ExceptionList, var_2c, var_28)
    int32_t var_8
    
    if (eax == 0)
        fsbase->NtTib.ExceptionList = var_8
        __return_addr = sub_494fac
