...
void*sub_4f5434(void* arg1)
{
    ...
    if (not(test_bit(eax_2:1.b, 0)))
        ...
        if (test_bit(eax_15:1.b, 0))
            *(*(arg1 + 8) - 0x30) = fconvert.s(sub_402b2c(
                float.t(*(arg1 - 8)) / float.t(*(*(arg1 + 8) - 0x50)) * fconvert.t(1f) * data_4f5594
                + data_4f55a0) + fconvert.t(-0f))
    ...
    *(*(arg1 + 8) - 0x30) = fconvert.s(data_4f55b4 * fconvert.t(*(*(arg1 + 8) - 0x30)))
    void* result = *(arg1 + 8)
    *(result - 0x34) = fconvert.s(data_4f55b4 * fconvert.t(*(*(arg1 + 8) - 0x34)))
    return result
}
