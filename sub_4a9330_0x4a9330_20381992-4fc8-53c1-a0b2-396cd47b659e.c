...
// [交叉引用字符串]: 无
// [外部 API 调用]: 无
// [内部子函数调用]: sub_403828, sub_4a3abc, sub_405ae8, sub_403df8, sub_40b4b0
// [被调用的父级函数]: sub_4ab0e0
// ============================================================

int32_t* __convention("regparm")sub_4a9330(int32_t* arg1, int32_t arg2, int32_t arg3)
{
    // 第一条实际指令: int32_t ebp
    int32_t ebp
    int32_t var_4 = ebp
    ...
    sub_4a3abc(arg3, arg1[0x1a], 0)
    fsbase->NtTib.ExceptionList = var_8
    __return_addr = sub_4a93a7
