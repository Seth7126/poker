...
// 函数名称: sub_41c730
// 虚拟地址: 0x41c730
// WARP GUID: d2028768-ffbb-5056-9be2-8f448cab1d20
// 源二进制: E:/torrent/BOARDGAMES/Texas Hold'em Poker 3D Deluxe Edition T/Poker3d.exe.bndb
// ------------------------------------------------------------
// [交叉引用字符串]: 无
// [外部 API 调用]: MulDiv, GetEnhMetaFileHeader
// [内部子函数调用]: sub_41c3a4, sub_41c7a4
// [被调用的父级函数]: 无
// ============================================================

void* __convention("regparm")sub_41c730(int32_t* arg1, int32_t arg2, int32_t arg3 @ esi)
{
    ...
    if (*(result + 0x18) != 0)
        return sub_41c7a4(arg1, MulDiv(arg2, 0x9ec, data_53165c))
    
    HENHMETAFILE hemf = *(result + 8)
    
    if (hemf != 0)
        GetEnhMetaFileHeader(hemf, 0x64, &enhMetaHeader)
        return sub_41c7a4(arg1, 
